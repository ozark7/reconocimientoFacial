...
#cap = cv2.VideoCapture('D:/UPC2024-2/IA/2 corte/reconocimientoFacial/users/pepi.mp4')#USUARIOS EXISTENTES

#cap = cv2.VideoCapture('D:/UPC2024-2/IA/2 corte/reconocimientoFacial/test/break.MP4')#PRUEBA
